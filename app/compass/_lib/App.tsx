    ...
    <ChatProvider>
      ...
      <div style={narrow
        ...
        <main style={narrow
          ...
          {docTabs}
          {/* the ONLY scroll region on desktop; native (smooth) wheel, no scrollbar */}
          <div className="compass-scroll" style={narrow ? { flex: 1, minWidth: 0 } : { flex: 1, minWidth: 0, minHeight: 0, overflowY: 'auto' }}>{main}</div>
        </main>
...
const linkStyle: React.CSSProperties = { fontFamily: 'IBM Plex Sans, system-ui, sans-serif', fontSize: 11, color: '#14171d', textDecoration: 'none' };
